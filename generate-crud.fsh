project-new --named orange-crud --stack JAVA_EE_7 --top-level-package org.jboss.orange.crud
...
jpa-new-field --named user --type org.jboss.orange.crud.model.User --relationship-type Many-to-One
...
jpa-new-field --named url --type org.jboss.orange.crud.model.URL --relationship-type Many-to-One
...
jpa-new-field --named history --type org.jboss.orange.crud.model.History --relationship-type Many-to-One
