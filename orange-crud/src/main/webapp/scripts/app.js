...
angular.module('orangecrud',['ngRoute','ngResource'])
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .when('/Histories',{templateUrl:'views/History/search.html',controller:'SearchHistoryController'})
      .when('/Histories/new',{templateUrl:'views/History/detail.html',controller:'NewHistoryController'})
      .when('/Histories/edit/:HistoryId',{templateUrl:'views/History/detail.html',controller:'EditHistoryController'})
